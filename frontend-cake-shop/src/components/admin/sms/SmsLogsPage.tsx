...
const MOCK_LOGS: SmsLog[] = [
  { id: 1, sent_at: '2025-06-11T10:30:00Z', phone_number: '09123456789', content: 'سفارش شما با شماره #BAKE-1245 ثبت شد.', status: 'success' },
  { id: 2, sent_at: '2025-06-11T11:00:00Z', phone_number: '09355555555', content: 'متأسفانه سفارش شما لغو گردید.', status: 'failed' },
  { id: 3, sent_at: '2025-06-11T11:05:00Z', phone_number: '09121112233', content: 'سفارش شما در حال آماده‌سازی است.', status: 'pending' },
];
